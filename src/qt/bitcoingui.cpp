                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XBI Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XBI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xbi: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXBI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XBI Core"), this);
    aboutAction->setStatusTip(tr("Show information about XBI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XBI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XBI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XBI addresses"));
    ...
    openAction->setStatusTip(tr("Open a XBI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XBI Core help message to get a list with possible XBI command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XBI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XBI network", "", count));
}
...
{
    QString strTitle = tr("XBI Core"); // default title
...
/** Creates context menu, its actions, and xbis up all the relevant signals for mouse events. */
