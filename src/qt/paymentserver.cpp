...
const char* BIP71_MIMETYPE_PAYMENT = "application/xbi-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/xbi-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/xbi-paymentrequest";
...
//
// OSX-specific way of handling xbi: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in xbi: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach (const PAIRTYPE(CScript, CAmount) & sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom xbi addresses are not supported
