                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received XBI from zXBI"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXBI"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXBI));
