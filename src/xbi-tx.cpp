...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XBI Core xbi-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xbi-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xbi transaction") + "\n" +
                               "  xbi-tx [options] -create [commands]   " + _("Create hex-encoded xbi transaction") + "\n" +
                               "\n";
