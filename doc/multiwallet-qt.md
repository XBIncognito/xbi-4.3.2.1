...
In order to support loading of multiple wallets in xbi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xbi.cpp.
...
Changes to xbi.cpp
----------------------
xbi.cpp is the entry point into xbi-qt, and as such, will require some minor modifications to provide hooks for
